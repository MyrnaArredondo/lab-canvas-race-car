window.onload = function() {
  ...
  let gameArea = {
    ...
    drawRoad : function(){
              this.context.fillStyle = "#095809";
              this.context.fillRect(0,0,300,600);
              this.context.fillStyle = "#575457"
  ...
  function updateGameArea(){
    ...
    if (gameArea.frames % 100 === 0) {
        ...
        myObstacles.push(new Obstacle(width, 15, "#9D050E  ", 35 + Math.floor(Math.random()*(240-width)), 0));
    }
    for (i = 0; i < myObstacles.length; i += 1) {
        myObstacles[i].y += 2;
